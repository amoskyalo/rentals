...
import paperwork from '../../Assets/paperwork.jpeg';
import accounting from '../../Assets/accounting.jpg';
import security from '../../Assets/security.jpg';
import cost from '../../Assets/cost.png';
import userfriendly from '../../Assets/user.png';


export const datas = [
    {img: ease, title:"Ease", text: "Ease in management of rentals, tenants’ caretaking, and even space management and accounting. You do not have to stress yourself nor do you have to be present at all times to manage your rentals."},
    {img: access, title: "Access", text:"You have access to your rentals from virtually anywhere in the world. You have access to information about the property, vacancies or even payments. At any time of the day. Accessibility is enjoyed to the maximum."},
    {img: backup, title:"Backup and Recovery", text: "In case of an accident, you have little/ or no chance of losing any of the vital information that you have to gather and kept over the years. This cannot be said for paperwork."},

    ...
    <div className="flex flex-col max-w-screen-xl mx-auto px-2 md:px-0">
      ...
      <div className="policy mb-5 mx-auto bg-white md:px-5 md:py-10">
        ...
        <p>
          ...
          and Renters Success may further restrict access by you to any areas of
        ...
        <p>
          ...
          display on this Website. By displaying Your Content, you grant Renters
          Success a non-exclusive, worldwide irrevocable, sub licensable license
        ...
        <p>
          ...
          third-party’s rights. Renters Success reserves the right to remove any
        ...
        <h2>No warranties</h2>
        <p>
          This Website is provided "as is," with all faults, and Renters Success
        ...
        <p>
          In no event shall Renters Success, nor any of its officers, directors
          ...
          is under contract.  Renters Success, including its officers, directors
        ...
        <p>
          ...
          laws of the State of ke, and you submit to the non-exclusive

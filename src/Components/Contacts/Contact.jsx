  ...
  return (
    ...
    >
      <div className="flex flex-col justify-between items-center space-y-5 md:flex-row md:space-y-0">
        ...
        <Link className="border py-2 px-10 text-semibold text-white text-base rounded-3xl flex items-center gap-2 md:text-xl md:py-2 md:px-10 hover:bg-white hover:text-navColor ease-in-out duration-500">

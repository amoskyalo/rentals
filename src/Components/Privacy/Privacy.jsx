  ...
  return (
    <div className="flex flex-col max-w-screen-xl mx-auto">
      ...
      <div className="policy mb-5 mx-auto bg-white md:px-5 md:py-10 md:mb-10">
        ...
        <p>
          At <a href="https://rentalsuccess.netlify.app/">Renters Success</a>,
          one of our main priorities is the privacy of our visitors. This
          Privacy Policy document contains types of information that is
          collected and recorded by
          <a href="https://rentalsuccess.netlify.app/"> Renters Success</a> and
          how we use it.
        </p>
        <p>
        ...
        <p>
          ...
          <a href="https://rentalsuccess.netlify.app/">Renters Success</a>. This
        ...
        <p>
          ...
          <a href="https://rentalsuccess.netlify.app/">Renters Success</a> uses
        ...
        <ul>
          <li>
            <p>Qwarqo</p>
            <p>
              <a href="https://qwarqo.com/policy">https://qwarqo.com/policy</a>
            </p>
          </li>
        </ul>
        ...
        <p>
          Note that{" "}
          <a href="https://rentalsuccess.netlify.app/">Renters Success</a> has
        ...
        <p>
          <a href="https://rentalsuccess.netlify.app/">Renters Success</a> does

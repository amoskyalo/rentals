...
export const data = [
  {
    ...
    original: 3,
    description:
      "Includes rent due reminder messages to tenants and registration of up to two plots",
  },
  {
    name: "Basic",
    category: "individual",
    ...
    original: 4.2,
    description:
      "Includes rent due reminder messages to tenants and registration of up to five plots",
  },
  {
    name: "Premium",
    category: "sacco",
    ...
    original: 10.5,
    description:
      "Package includes rent due reminder messages to tenants and registration of up to ten plots",
  },
  {
    name: "VIP",
    category: "sacco",

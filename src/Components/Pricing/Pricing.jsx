  ...
  return (
    <section>
      ...
      <div className="flex flex-col max-w-screen-xl mx-auto my-5 text-center md:my-20">
        ...
        <div className="grid grid-cols-1 space-y-7 px-4 mx-auto mt-10 md:px-0 md:space-y-0 md:w-[75%] md:flex md:flex-row md:space-x-5">
          {data.map((offer, i) => (
            <div className="flex flex-col w-full md:w-1/4" key={i}>
